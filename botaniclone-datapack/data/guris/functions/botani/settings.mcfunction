...
execute if score option_fungus guris.botani matches 1.. run tellraw @s ["",{"text":"[ ✔ ]","color":"green","clickEvent":{"action":"run_command","value":"/function guris:botani/options/toggle/fungus"}},{"text":" Fungi","bold":true},{"text":": You can use bone meal on "},{"text":"nether/warped wart block, shroomlight","underlined":true,"hoverEvent":{"action":"show_text","value":"also potted crimson fungus, warped fungus by option"}}]
execute unless score option_fungus guris.botani matches 1.. run tellraw @s ["",{"text":"[ ❌ ]","color":"red","clickEvent":{"action":"run_command","value":"/function guris:botani/options/toggle/fungus"}},{"text":" Fungi","bold":true},{"text":": You cannot use bone meal on "},{"text":"nether/warped wart block, shroomlight","underlined":true,"hoverEvent":{"action":"show_text","value":"also potted crimson fungus, warped fungus by option"}}]
